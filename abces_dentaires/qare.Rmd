...
summary(glm(data = qare, has_antibiotic ~ patient_age_range))
glm(data = qare, has_antibiotic ~ patient_gender) %>% summary()
glm(data = qare, has_antibiotic ~ department_code) %>% summary()
glm(data = qare, has_antibiotic ~ physician_gender) %>% summary()
glm(data = qare, has_antibiotic ~ physician_age_range) %>% summary()
...
glm(data = qare, has_antibiotic ~ cim10) %>% summary()
summary(glm(
